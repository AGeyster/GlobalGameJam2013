...
namespace Platformer
{
    ...
    public class Player
    {
        ...
        {
            return (int)Stress.getCurrentHeartRate();
        }
        /// <summary>
        ...
        {
            Stress.setCurrentHeartRate(100);
            Position = position;
            ...
            DisplayOrientation orientation)
        {
            ...
            {
                int count = 0;
                while (count < dieAnimation.FrameWidth / 128)
                {
            ...
            DisplayOrientation orientation)
        {
            ...
            if (keyboardState.IsKeyDown(Keys.LeftShift))
            {
                if (!shiftDown)
                {
                    this.MaxMoveSpeed = this.MaxMoveSpeed * 1.75F;
                    this.MoveAcceleration = this.MoveAcceleration * 1.75F;
                    runAnimation.setFrameTime(0.02f);
                    Stress.run();
                }
                shiftDown = true;
            }
